...
if(isset($_POST["titulo"]) && isset($_POST["texto"])){
  ...
  $result = $db->query("UPDATE noticias set titulo='$titulo', texto='$texto' WHERE id_noticia=$idNoticia");
  if(!$result) {
          ...
          <div class="card-body">
            <form method="post">
              <div class="form-group">
                <?php
                  $idNoticia = $_GET['id'];
                  $query = $db->query("SELECT * FROM noticias WHERE id_noticia = $idNoticia");
