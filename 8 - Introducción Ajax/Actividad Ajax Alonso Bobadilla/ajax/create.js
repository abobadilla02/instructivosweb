    ...
    function(dato) {
      ...
      if (dato.exito) {
        ...
        $('#tabla-registro').after(
          ...
          '<td>' + dato.telefono + '</td>' +
          '<td>' + variable + '</td>' +
          '<td> <button value=\'' + dato.rut + '\' type="button" class="btn btn-info" data-toggle="modal" href="#actualizar" name="actualizar">Actualizar</button> - <a id="eliminar" class="btn btn-danger" data-toggle="modal" href="#modal_eliminar">Eliminar</a></td>' +
          '</tr>'
